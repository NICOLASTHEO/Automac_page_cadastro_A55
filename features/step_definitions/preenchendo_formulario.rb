...
Quando('preencho o formulário corretamente') do
    ...
    fill_in(name:'email', with: "souumemail02@ig.com") # sempre colocar um e-mail diferente no teste.
    fill_in(name:'mobilephone', with: "11988776655")
    fill_in(name:'role', with: "Um cargo")
    fill_in(name:'cnpj', with: "13825476000103") #a aplicação permite apenas números. 
